         ...
         <div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span class="breadcrumb_last" aria-current="page"> You searched for {{$tukhoa}}</span></span></span></div>
                     </div>
                  </div>
               </div>
            ...
            <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
               <section>
                  <div class="section-bar clearfix">
                     <h1 class="section-title"><span>Kết quả tìm kiếm cho từ khóa {{$tukhoa}}</span></h1>
                  </div>
                  <div class="halim_box">
                  ...
                  <div class="text-center">
                     <ul class='page-numbers'>
                        <li class="{{$movie->currentPage()<=1?'hidden':''}}"><a class="next page-numbers" href="{{$movie->previousPageUrl()}}&keyword={{$tukhoa}}"><i class="fas fa-arrow-left"></i></a></li>
                        @for($i=1;$i<=$movie->lastPage();$i++)
                           ...
                           <li>
                              ...
                              @else
                              <a class="page-numbers" href="{{$movie->url($i)}}&keyword={{$tukhoa}}">{{$i}}</a>
                              @endif
                           </li>
                        ...
                        <li class="{{$movie->lastPage()==$movie->currentPage()?'hidden':''}}"><a class="next page-numbers" href="{{$movie->nextPageUrl()}}&keyword={{$tukhoa}}"><i class="fas fa-arrow-right"></i></a></li>
                     </ul>
                  </div>
                  @endif
               </section>
