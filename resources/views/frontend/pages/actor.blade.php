...
@section('title','Diễn viên '.$name_actor)
@section('content')
      <div class="container">
         <div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span class="breadcrumb_last uppercase" aria-current="page">{{$name_actor}}</span></span></span></div>
                     </div>
                  </div>
               </div>
            ...
            <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
               <section>
                  <div class="section-bar clearfix">
                     <h1 class="section-title uppercase"><span>Diễn viên: {{$name_actor}}</span></h1>
                  </div>
                  <div class="halim_box">
