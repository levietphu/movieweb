         ...
         <div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span class="breadcrumb_last" aria-current="page">Phim mới</span></span></span></div>
                     </div>
                  </div>
               </div>
                     ...
                     <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-27021">
                        <div class="halim-item">
                           <a class="halim-thumb" href="{{route('movie',$value->slug)}}" title="{{$value->name}}">
                              ...
                              <span class="status uppercase">{{$value->type==1?\App\Models\Episode::where('created_at',$value->time)->first()->description_name:\App\Models\Episode::where('created_at',$value->time)->first()->description_name}}</span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>{{\App\Models\Episode::where('created_at',$value->time)->first()->tran_episode->name}}</span> 
