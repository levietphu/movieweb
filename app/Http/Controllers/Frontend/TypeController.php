...
{
    public function odd_movie()
    {
        $movie = Movie::where('type',0)->paginate(1);
        ...
        return view('frontend.pages.type',compact('movie','to','from','top_view_all','top_view_this_day','top_view_this_Week','top_view_this_Month'));
    }
    public function series_movie()
    {
        $movie = Movie::where('type',1)->paginate(1);
