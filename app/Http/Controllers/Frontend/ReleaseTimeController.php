...
{
    public function release_time($slug)
    {
        $check = ReleaseTime::where('slug',$slug)->first();
        $movie = $check->release_movie()->paginate(1);
        ...
        return view('frontend.pages.release_time',compact('movie','to','from','top_view_all','top_view_this_day','top_view_this_Week','top_view_this_Month','slug'));
    }
}
